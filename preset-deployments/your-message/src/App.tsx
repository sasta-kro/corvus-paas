  ...
  return (
    <div className="page-container">
      <div className="message-container">
        ...
        <p className="message-flavor">The website link works everywhere, share it with your friends!</p>
        <p className="message-credits">
          Built by{' '}
          <a href="https://github.com/sasta-kro" target="_blank" rel="noopener noreferrer">
            sasta-kro
          </a>
        </p>
      </div>
